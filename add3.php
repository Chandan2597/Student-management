    ...
    <div class="container-fluid">
      ...
      <div class="card-body ">
        <h5 class="card-title"></h5>
          <p class="card-text"></p>
          <form action="save3.php" method="post" enctype="multipart/form-data" autocomplete="OFF">
        ...
        <div class="form-row">
          <div class="card bg-light" style="width: 180px;
                ...
                text-align: center;">
           <center><img src="abc1.png" id="profile-img-tag" width="160px" height="180px" /></center>
          </div>
        </div>
        <br>
        <div class="form-row">
          <div class="col-sm-6">
            <label for="formGroupExampleInput">Upload Faculty Image</label>
            <div class="custom-file">
              <input name="imglink1" type="file" class="custom-file-input" id="customFile" required>
          ...
          <div class="col-sm-2">
            ...
            <input name="id" type="text" class="form-control " id="formGroupExampleInput" placeholder="Enter Faculty Id" required>
            </div>
          </div>
          </div>
        ...
        <div class="form-row">
          ...
          <button name ="submit" type="submit" class="btn btn-success" style="width:120px;  font-size:18px">Add
