              ...
              <table class="table table-bordered table-hover " id="dataTable" width="100%" cellspacing="50px">
                ...
                <tbody>
                    ...
                    <?php
                       ...
                       $query_run1=mysqli_query($con,"select * from studentt,dept,course,enrolfor where studentt.dno=dept.dno and dept.dno=course.dno and studentt.id=enrolfor.id and course.cno=enrolfor.cno");
                      ...
                      while($row1 = mysqli_fetch_assoc($query_run1))
                       ...
                       <tr>
                          ...
                          <td width="15%"><a class="btn btn-outline-primary btn-sm" href='details.php?d=<?php echo $row1['id'] ?>' > <?php echo $row1['fname'] ?> <?php echo $row1['mname'] ?> <?php echo $row1['lname'] ?></a></td>
                          <td width="20%"><?php echo $row1['dname']?></td>
                          <td width="20%"><?php echo $row1['cname']?></td>
                          <td width="10%">
                              <a class="btn btn-danger btn-sm text-white" href='delete1.php?del1=<?php echo $row1['id'] ?>' ><i class="fa fa-trash-o" style="font-size:16px"></i></a>
                              <a class="btn btn-warning btn-sm text-white" href='edit1.php?ed1=<?php echo $row1['id'] ?>' ><i class="fa fa-pencil-square" style="font-size:16px"></i></a>
