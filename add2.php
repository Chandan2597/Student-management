...
<body class="fixed-nav sticky-footer bg-light" id="page-top" style="font-family: 'Roboto', sans-serif; font-size: 16px">
  ...
  <div class="content-wrapper">
	...
	<form action="save2.php"method="post" autocomplete="OFF">
<div class="col-sm-6">
	<div class="form-group" >
		<label for="formGroupExampleInput1">Department Id</label>
		<input name="dno" type="text" class="form-control " id="formGroupExampleInput1" placeholder="Enter Department Id" required autofocus>
...
<div class="col-sm-10">
  <div class="form-group">
		...
		<input name="dname" type="text" class="form-control " id="formGroupExampleInput2" placeholder="Enter Department Name" required>
